...
static uint16_t nsp2;
static int8_t nspVar2Inc;
...
static int16_t starlib_speed;
static int8_t speedChange;

static uint8_t pColor;
...
void JE_changeSetup( uint8_t setupType )
{
	stepCounter = 0;
