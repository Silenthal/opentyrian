...
extern uint16_t backPos, backPos2, backPos3;
extern uint16_t backMove, backMove2, backMove3;
extern uint16_t mapX, mapY, mapX2, mapX3, mapY2, mapY3;
extern uint8_t **mapYPos, **mapY2Pos, **mapY3Pos;
extern uint16_t mapXPos, oldMapXOfs, mapXOfs, mapX2Ofs, mapX2Pos, mapX3Pos, oldMapX3Ofs, mapX3Ofs, tempMapXOfs;
extern intptr_t mapXbpPos, mapX2bpPos, mapX3bpPos;
extern uint8_t map1YDelay, map1YDelayMax, map2YDelay, map2YDelayMax;
extern bool anySmoothies;  // if yes, I want one :D
extern uint8_t smoothie_data[9];
...
void JE_filterScreen( int8_t col, int8_t generic_int );
