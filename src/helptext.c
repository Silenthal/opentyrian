...
const uint8_t menuHelp[MENU_MAX][11] = /* [1..maxmenu, 1..11] */
{
...
uint8_t verticalHeight = 7;
uint8_t helpBoxColor = 12;
uint8_t helpBoxBrightness = 1;
uint8_t helpBoxShadeType = FULL_SHADE;
